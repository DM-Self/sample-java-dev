...
public class DealerDetailsController {
    ...
    @GetMapping(value = "/dealer-search", produces = MediaType.APPLICATION_JSON_VALUE) 
    public List<DealerDetails> findAllXML() {
    	List<DealerDetails> dealers = new ArrayList<>();
    	DealerDetails l_dealerDetails = new DealerDetails();
    	l_dealerDetails.setCity("Pune");
    	dealers.add(l_dealerDetails);
       return dealers;
    }
